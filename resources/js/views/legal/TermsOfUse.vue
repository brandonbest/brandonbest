                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row justify-content-center mb-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">Agreement </span> to Terms</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>

                        <p>These Terms of Use constitute a legally binding agreement made between you, whether
                            personally or on behalf of an entity (“you”) and Brandon Best ("Company", “we”, “us”, or
                            “our”), concerning your access to and use of the <a href="/">brandonbest.com</a> website as well as any
                        ...
                        <p>Supplemental terms and conditions or documents that may be posted on the Site from time
                            ...
                            these
                            Terms of Use, and you waive any right to receive specific notice of each such change. It
                            is
                            your responsibility to periodically review these Terms of Use to stay informed of
                            updates.
                        ...
                        <p>The information provided on the Site is not intended for distribution to or use by any
                            person
                            or entity in any jurisdiction or country where such distribution or use would be
                            contrary to
                        ...
                        <p>The Site is intended for users who are at least 13 years of age. All users who are minors
                            ...
                            Use
                            prior to you using the Site.</p>

                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">INTELLECTUAL </span> PROPERTY RIGHTS</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">USER </span> REPRESENTATIONS</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>

                        <p>By using the Site, you represent and warrant that: (1) you have the legal capacity and you
                            agree
                            to comply with these Terms of Use; (2) you are not under the age of 13; (3) you are not a
                            minor
                            ...
                            through a bot, script, or otherwise; (5) you will not use the Site for any illegal or
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">PROHIBITED </span> ACTIVITIES</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">USER </span> GENERATED CONTRIBUTIONS</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <p>The Site does not offer users to submit or post content. We may provide you with the
                            ...
                            accordance with the <router-link :to="{ name: 'legal.privacy' }" _target="blank">Site Privacy Policy</router-link>. When you create or make available any
                        ...
                        <p>Any use of the Site in violation of the foregoing violates these Terms of Use and may result
                            in,
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">CONTRIBUTION </span> LICENSE</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <p>You and the Site agree that we may access, store, process, and use any information and
                            personal
                            data that you provide following the terms of the <router-link :to="{ name: 'legal.privacy' }" _target="blank">Privacy Policy</router-link> and your choices (including
                            settings).</p>
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">SUBMISSIONS </span></h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">THIRD-PARTY </span> WEBSITE AND CONTENT</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">SITE </span> MANAGEMENT</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <p>We reserve the right, but not the obligation, to: (1) monitor the Site for violations of
                            ...
                            limitation,
                            notice, or liability, to remove from the Site or otherwise disable all files and content
                            that
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">PRIVACY </span> POLICY</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <p>We care about data privacy and security. Please review our Privacy Policy:
                            <router-link :to="{ name: 'router.privacy' }" _target="blank">https://www.brandonbest.com/legal/privacy</router-link>. By using the Site, you agree to be bound by our
                            Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is
                            hosted in the United States. If you access the Site from any other region of the world with
                            laws
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">TERM </span> AND TERMINATION</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <p>These Terms of Use shall remain in full force and effect while you use the Site. WITHOUT
                            ...
                            WITHOUT
                            LIMITATION FOR BREACH OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE TERMS
                            OF
                            USE OR OF ANY APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN
                            THE
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">MODIFICATIONS </span> AND INTERRUPTIONS</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">GOVERNING </span> LAW</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">DISPUTE </span> RESOLUTION</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        located in Maricopa, Arizona, and the Parties hereby consent to, and waive all defenses of
                        lack
                        ...
                        excluded from these Terms of Use. In no event shall any claim, action, or proceeding brought
                        by
                        either Party related in any way to the Site be commenced more than one (1) years after the
                        cause
                        of action arose.
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">CORRECTIONS </span></h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">DISCLAIMER </span></h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        AND
                        OUR SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM
                        ALL
                        ...
                        FROM
                        YOUR ACCESS TO AND USE OF THE SITE, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE
                        SERVERS
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">LIMITATIONS </span> OF LIABILITY</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        THE
                        SITE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING
                        ANYTHING
                        TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND
                        REGARDLESS
                        OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU
                        TO US
                        DURING THE three (3) mONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN US STATE
                        LAWS
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">INDEMNIFICATION </span></h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        by
                        any third party due to or arising out of: (1) use of the Site; (2) breach of these Terms of
                        Use;
                        (3) any breach of your representations and warranties set forth in these Terms of Use; (4)
                        your
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">USER </span> DATA</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        or
                        that relates to any activity you have undertaken using the Site. You agree that we shall
                        have no
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">ELECTRONIC </span> COMMUNICATIONS, TRANSACTIONS, AND
                                    SIGNATURES</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        ...
                        BY
                        US OR VIA THE SITE. You hereby waive any rights or requirements under any statutes,
                        regulations,
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">CALIFORNIA </span> USERS AND RESIDENTS</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">MISCELLANEOUS </span></h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        waiver
                        of such right or provision. These Terms of Use operate to the fullest extent permissible by
                        law.
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">CONTACT </span> US</h2>
                                    <div class="main-title-border"><i class="fas fa-gavel ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
