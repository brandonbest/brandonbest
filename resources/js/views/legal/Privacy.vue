<template>
    <div>
        <PageTitle title="Privacy" subtitle="Last updated July 26, 2020" router-name="legal" router-title="Legal"></PageTitle>

        <section class="section section-legal">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p>Thank you for choosing to be part of our community at Brandon Best (“Company”, “we”, “us”, or “our”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at privacy@brandonbest.com.</p>

                        <p>When you visit our website https://www.brandonbest.com (the "Website"), and more generally, use any of our services (the "Services", which include the Website), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.</p>
                        ...
                        <div class="row justify-content-center mb-5 mt-5">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">TABLE </span> OF CONTENTS</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>

                        <ol class="table-contents text-center">
                            <p><a href="#one-information-collect">WHAT INFORMATION DO WE COLLECT?</a></p>
                            <p><a href="#two-use-information">HOW DO WE USE YOUR INFORMATION?</a></p>
                            <p><a href="#three-share-information">WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a></p>
                            <p><a href="#four-cookies-tracking">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></p>
                            <p><a href="#five-store-information">HOW LONG DO WE KEEP YOUR INFORMATION?</a></p>
                            <p><a href="#six-security">HOW DO WE KEEP YOUR INFORMATION SAFE?</a></p>
                            <p><a href="#seven-minors">DO WE COLLECT INFORMATION FROM MINORS?</a></p>
                            <p><a href="#eight-security">WHAT ARE YOUR PRIVACY RIGHTS?</a></p>
                            <p><a href="#nine-do-not-track">CONTROLS FOR DO-NOT-TRACK FEATURES?</a></p>
                            <p><a href="#ten-ccpa">DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></p>
                            <p><a href="#eleven-updates">DO WE MAKE UPDATES TO THIS NOTICE?</a></p>
                            <p><a href="#twelve-contact">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></p>
                        </ol>

                        <div class="row justify-content-center mb-5 mt-5 pt-5" id="one-information-collect">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">WHAT </span> INFORMATION DO WE COLLECT?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <p>Personal Information Provided by You. We collect names; phone numbers; email addresses; job titles; contact preferences; and other similar information.
                        ...
                        <p>Like many businesses, we also collect information through cookies and similar technologies. You can find out more about this in our Cookie Notice: <router-link :to="{ name: 'legal.cookies' }" _target="blank">https://www.brandonbest.com/legal/cookies</router-link>.</p>
                        ...
                        <div class="row justify-content-center mb-5 mt-5" id="two-use-information">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">HOW </span> DO WE USE YOUR INFORMATION?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5" id="three-share-information">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">WILL </span> YOUR INFORMATION BE SHARED WITH ANYONE?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5" id="four-cookies-tracking">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">DO WE </span> USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <p>We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <router-link :to="{ name: 'legal.cookies' }" _target="blank">https://www.brandonbest.com/legal/cookies</router-link>.</p>

                        <div class="row justify-content-center mb-5 mt-5" id="five-store-information">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">How </span> LONG DO WE KEEP YOUR INFORMATION?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5" id="six-security">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">HOW </span> DO WE KEEP YOUR INFORMATION SAFE?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5" id="seven-minors">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">DO WE </span> COLLECT INFORMATION FROM MINORS?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Website, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Website. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at dpo@brandonbest.com.

                        <div class="row justify-content-center mb-5 mt-5" id="eight-security">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">WHAT </span> ARE YOUR PRIVACY RIGHTS?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5" id="nine-do-not-track">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">CONTROLS </span> CONTROLS FOR DO-NOT-TRACK FEATURES?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5" id="ten-ccpa">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">DO </span> CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <ol>
                            ...
                            <li>every individual who is domiciled in the State of California who is outside the State of California for a temporary or transitory purpose
                                All other individuals are defined as "non-residents."</li>
                        </ol>

                        If this definition of "resident" applies to you, certain rights and obligations apply regarding your personal information.

                        <h4 class="mt-4 mb-1">What categories of personal information do we collect?</h4>
                        ...
                        <table class="table table-hover">
                            ...
                            <tr class="table-dark">
                                ...
                                <td>Business contact details in order to provide you our services at a business level, job title as well as work history and professional qualifications if you apply for a job with usBusiness contact details in order to provide you our services at a business level, job title as well as work history and professional qualifications if you apply for a job with us</td>
                                <td class="text-center">NO</td>
                            </tr>
                            <tr class="table-dark">
                        ...
                        <h4 class="mt-4 mb-1">How do we use and share your personal information?</h4>

                        <p>More information about our data collection and sharing practices can be found in this privacy notice and our Cookie Notice: <router-link :to="{ name: 'legal.cookies' }" _target="blank">https://www.brandonbest.com/legal/cookies</router-link>.</p>

                        <p>You may contact us by email at gdpr@brandonbest.com, or by referring to the contact details at the bottom of this document.</p>
                        ...
                        <h4 class="mt-4 mb-1">Will your information be shared with anyone else?</h4>
                        ...
                        <p>Brandon Best has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. Brandon Best will not sell personal information in the future belonging to website visitors, users and other consumers.</p>

                        <h4 class="mt-4 mb-1">Your rights with respect to your personal data</h4>
                        ...
                        <h5 class="mt-4 mb-1">Right to be informed - Request to know</h5>
                        ...
                        <h5 class="mt-4 mb-1">Right to Non-Discrimination for the Exercise of a Consumer's Privacy Rights</h5>

                        <p>We will not discriminate against you if you exercise your privacy rights.</p>

                        <h5 class="mt-4 mb-1">Verification process</h5>
                        ...
                        <h5 class="mt-4 mb-1">Other privacy rights</h5>
                        ...
                        <p>To exercise these rights, you can contact us by email at gdpr@brandonbest.com, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>


                        <div class="row justify-content-center mb-5 mt-5" id="eleven-updates">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">DO </span> WE MAKE UPDATES TO THIS NOTICE?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mb-5 mt-5" id="twelve-contact">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">HOW </span> CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        <p>If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO), Brandon Best, by email at dpo@brandonbest.com, by phone at (602) 910-5898, or by post to:

                        <p>Brandon Best<br/>
                        Gilbert, AZ 85296<br/>
                        United States</p>

                        <p>privacy@brandonbest.com</p>

                        <div class="row justify-content-center mb-5 mt-5" id="thirteen-review">
                            <div class="col-lg-12">
                                <div class="text-center mx-auto section-main-title"><h2 class="mb-3"><span
                                        class="font-weight-bold">HOW </span> CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
                                    <div class="main-title-border"><i class="fas fa-user-lock ml-2 mr-2"></i></div>
                                </div>
                            </div>
                        </div>
                        <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please visit: <router-link :to="{ name: 'router.data' }" _target="blank">https://www.brandonbest.com/legal/data</router-link>. We will respond to your request within 30 days.</p>
                    </div>
                </div>
            </div>
        </section>
